...
public class ParcoutController {
    ...
    public ResponseEntity<Parcourt> addParcourt( @RequestHeader("Authorization") String token,@RequestBody  Parcourt parcourt) throws ParcoursExisteExeption, NotAuthorized {
